        ...
        <section className="bg-white dark:bg-dark-800 rounded-lg p-6 border border-neutral-200 dark:border-dark-600">
          ...
          <form onSubmit={handleSettingsSave} className="space-y-6">
            ...
            <div className="flex flex-col gap-3">
              ...
              {whisperModelsLoading && whisperModels.length === 0 && (
                <div className="flex items-center gap-2 text-sm text-neutral-600 dark:text-dark-400">
